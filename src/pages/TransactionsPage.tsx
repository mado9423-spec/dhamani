              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    ...
                    <p className="mt-0.5 text-[12px] font-medium tabular-nums text-ink-soft">
                      رقم المعاملة: {t.transactionNumber}
                    </p>
                  </div>
                  <StatusBadge status={t.status} />
                </div>
                <div className="flex justify-between border-t border-line-soft pt-2 text-[12px] font-medium tabular-nums text-ink-faint">
